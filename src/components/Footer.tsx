...
const Footer = () => {
  return (
    <footer className="bg-roast-900 text-roast-100 py-12">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          ...
          <div className="md:w-1/4">
            <h3 className="text-white font-medium mb-4 md:text-right">Company</h3>
        ...
        <div className="border-t border-roast-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-roast-400 mb-4 md:mb-0">© 2023 Every Roast. All rights reserved.</p>
          <div className="flex space-x-6">
            <a href="#" className="text-roast-400 hover:text-white transition-colors">
